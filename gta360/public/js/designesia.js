...
// --------------------------------------------------
	...
	$('.image-popup-gallery').magnificPopup({
        ...
        jQuery('#slider-edit').magnificPopup({
          type: 'ajax',
          alignTop: true,
          overflowY: 'scroll',
          closeOnContentClick: false,
        ...
        jQuery('.btn-magnific').magnificPopup({
          type: 'ajax',
          ajax: {
            settings: {
              dataType: "html"
...
// --------------------------------------------------
	...
	function video_autosize(){
		jQuery('.de-video-container').each(function() {
			// Custom
			var video_height = jQuery(this).find('video').css('height');
			jQuery(this).css('height', video_height);
...
// one page navigation
		...
		jQuery("a.btn:not(.no-scrollto), a.btn-slider").click(function(evn){
